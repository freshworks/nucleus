...
module('Integration | Component | nucleus-button', function(hooks) {
  ...
  test('buttons pass visual regression tests', async function(assert) {
    await render(hbs`{{nucleus-button label="LabelButton"}} {{#nucleus-button}}Button{{/nucleus-button}} {{#nucleus-button size="mini"}}Mini{{/nucleus-button}} {{#nucleus-button size="small"}}Small{{/nucleus-button}} {{#nucleus-button variant="secondary"}}Secondary{{/nucleus-button}} {{#nucleus-button variant="danger"}}Danger{{/nucleus-button}} {{#nucleus-button variant="link"}}Link{{/nucleus-button}} {{#nucleus-button variant="text"}}Text{{/nucleus-button}} {{#nucleus-button block=true}}Block Button{{/nucleus-button}} {{#nucleus-button disabled=true}}Secondary{{/nucleus-button}} {{nucleus-button icon="nucleus-circle-check" variant="secondary"}} {{nucleus-button icon="nucleus-circle-check" size="small" variant="secondary"}} {{nucleus-button icon="nucleus-circle-check" size="mini" variant="secondary"}}`);
